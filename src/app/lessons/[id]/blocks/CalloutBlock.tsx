import { CalloutBlock as CalloutBlockType } from '../types/blocks'

export default function CalloutBlock({ variant, title, content, icon }: CalloutBlockType) {
  const styles = {
    info: {
    ...
    tip: {
      bg: 'bg-gradient-to-r from-green-50 to-emerald-100/50',
    ...
    success: {
      bg: 'bg-gradient-to-r from-emerald-50 to-green-100/50',
